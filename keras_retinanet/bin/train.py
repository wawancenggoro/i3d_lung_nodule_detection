...
def main(args=None):
    ...
    print('\n' +'Train generator at rgb_sample: ' + '\n' +str(train_generator.__getitem__(1)[0].shape))
    ...
    print('........Connecting to Retinanet Models........')
    print('----------------------------------------------')
    print()
...
#     return training_model, prediction_model
    ...
    print('----------------------------------------------')
    print('...WARNING!!!! SYSTEM STARTING THE TRAINING...')
    print('----------------------------------------------')
    # start training
